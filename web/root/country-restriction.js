...
function display_access_denied_error() {
    document.body.innerHTML
        ...
        + 'Access Denied Your country is banned. Reason: Griefing. If you want it unbanned discord: id4l#2978'
        + '</span>'
        + '</div>'
        + '</div>'
}
...
// allow_whitelist_countries() // Allow whitelist countries// allow_whitelist_countries() // Allow whitelist countries